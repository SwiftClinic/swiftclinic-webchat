    ...
    function finishTypingWith(text){
      ...
      setTimeout(function(){
        ...
        if(t){
          ...
          msgs.scrollTop = msgs.scrollHeight;
          if(String(text||'') === String(welcomeMessage||'')) { renderStarters(); try{ sessionStorage.setItem(welcomeKey, '1') }catch(_){ } welcomeShown=true; }
        } else {
